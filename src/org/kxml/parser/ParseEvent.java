...
public class ParseEvent
{
	...
	public Attribute getAttribute(String namespace, String name)
	{
		...
		for (int i = 0; i < len; i++)
		{
			...
			if (attr.getKey().equals(name) && (namespace == null || namespace.equals(attr.getNamespace())))
	...
	public Attribute getAttributeIgnoreCase(String name)
	{
		return getAttributeIgnoreCase(Xml.NO_NAMESPACE, name);
	}
	...
	public Attribute getAttributeIgnoreCase(String namespace, String name)
	{
		...
		for (int i = 0; i < len; i++)
		{
			...
			if (attr.getKey().equalsIgnoreCase(name) && (namespace == null || namespace.equals(attr.getNamespace())))
	...
	{
		List<Attribute> a = getAttributes();
	 ...
	 * corresponding string is returned. For all other event types, null is
	 * returned.
	 */
	...
	{
		return "ParseEvent type=" + Xml.getType(type) + " text='" + text + "'";
	}
