...
public class JCal extends GenericWebControl implements ValueHolder
{
	...
	public void render(RenderPrinter outputStream) throws Exception
	{
		...
		String script = new StringBuffer("$('#").append(getId()).append("').datepicker({changeYear: true,showOtherMonths: true,showWeek: ")
				.append(getShowWeek()).append(",selectOtherMonths: true});").toString();
