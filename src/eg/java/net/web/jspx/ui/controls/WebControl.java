...
public abstract class WebControl implements Serializable {
    ...
    String position = "";
    @JspxAttribute
    private final String isSafe = "issafe";
    /**
    ...
    public String toString() {
        return "<" + tagName + " id=" + (getId() == null ? "" : getId()) + ">\n" + attributes;
    }
    ...
    protected boolean childOfItemDataBound(boolean recursive) {
        ...
        if (recursive) {
            if (this.parent != null)
                return this.parent.childOfItemDataBound(true);
        }
        return false;
    }
    ...
    public IAjaxSubmitter getMyAjaxSubmitter() {
        ...
        if (!StringUtility.isNullOrEmpty(val) && page != null) {
            ...
            return (IAjaxSubmitter) (!(wc instanceof IAjaxSubmitter) ? myAjaxSubmitter : wc);
