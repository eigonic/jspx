...
public class Footer extends GenericWebControl
{
	...
	@JspxAttribute
	private String footerMessage = "message";
	...
	@JspxAttribute
	private String newText = "newcommandtext";
	...
	@JspxAttribute
	private String prevText = "prevcommandtext";
	...
	@JspxAttribute
	private String nextText = "nextcommandtext";
	...
	@JspxAttribute
	private String firstText = "firstcommandtext";
	...
	@JspxAttribute
	private String lastText = "lastcommandtext";
	...
	@JspxAttribute
	private String exportToExcelText = "exportToExcelText";
	...
	@JspxAttribute
	private String hidePaging = "hidePaging";
	...
	protected void renderPageIndex(RenderPrinter outputStream, Table parentTable, boolean navigationThrough) throws Exception
	{
		...
		String totalPagesString = navigationThrough ? "...." : String.valueOf(new DecimalFormat("###,###,###").format(parentTable.getTotalPages()));
		String totalCountString = navigationThrough ? "...." : String.valueOf(new DecimalFormat("###,###,###").format(parentTable.getTotalCount()));
		...
		// Render.renderStartTag(outputStream, TagFactory.Span, "add-on", null);
		// Render.renderStartTag(outputStream, TagFactory.Span, "caret", "vertical-align: middle;");
			...
			boolean navigationThrough) throws Exception
	{
		...
		if (currentPage > 1 || hasNext)
		{
			...
			// Render.renderImgCommand(outputStream, NavigateEvent, String.valueOf(currentPage + 1),
			// ResourceHandler.ResourcePrefix
			// + ResourceUtility.Next, StringUtility.isNullOrEmpty(getNextCommandText()) ? "Next" : getNextCommandText(), null,
			// enabled, true,
			// null, null, false, page, parentTable.getId(), parentTable);
			Render.renderCloseTag(outputStream, TagFactory.ListItem);
			Render.renderStartTag(outputStream, TagFactory.ListItem, null, null);
			if (!navigationThrough)
			{
				...
				// Render.renderImgCommand(outputStream, NavigateEvent, String.valueOf(parentTable.getTotalPages()),
				// ResourceHandler.ResourcePrefix
				// + ResourceUtility.Last, StringUtility.isNullOrEmpty(getLastCommandText()) ? "Last" : getLastCommandText(),
				// null, enabled,
				// true, null, null, false, page, parentTable.getId(), parentTable);
			}
			Render.renderCloseTag(outputStream, TagFactory.ListItem);
