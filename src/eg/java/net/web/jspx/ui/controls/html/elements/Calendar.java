...
public class Calendar extends GenericWebControl implements ValueHolder
{
	...
	private String showweek = "showweek";
	...
	public void render(RenderPrinter outputStream) throws Exception
	{
		...
		String script = new StringBuffer("$('#").append(getId()).append("'").append(document).append(").").append(mode)
				.append("({changeYear: true,showOtherMonths: true,showSecond: true,timeFormat: 'hh:mm:ss',showWeek: ").append(getShowWeek())
				.append(",selectOtherMonths: true,dateFormat:'dd/mm/yy'});").toString();
