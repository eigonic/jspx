...
public class GenericWebControl extends WebControl
{
	...
	public WebControl clone(WebControl parent, Page page, ISubmitter submitter, IAjaxSubmitter ajaxSubmitter)
	{
		...
		// if (parent != null)
		// {
		// newGenericWebControl.setIndentLevel(parent.getIndentLevel() + 1);
		//
		// }
		...
		// if (newGenericWebControl.isDataModelChild && newGenericWebControl
		// instanceof ValueHolder)
		// page.addItemDataBoundChildControl(newGenericWebControl.getId(),
		// newGenericWebControl);
