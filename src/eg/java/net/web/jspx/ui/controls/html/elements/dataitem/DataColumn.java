...
public class DataColumn extends HiddenGenericWebControl {
    ...
    private final String ColName = "fieldname";
    private final String textKey = "text";
    private final String type = "type";
    private final String fk = "lookup";
     ...
     */
    @JspxAttribute
    private final String sortDirection = "sortdir";
    ...
    private boolean evaluateExp(String exp) {
        ...
        return value.equalsIgnoreCase(parts[1]);
    }
    ...
    public void render(RenderPrinter outputStream) throws Exception {
        ...
        try {
            ...
            String thisId = table.getId() + Table.nameSplitter +
                    (isEdit ? Table.nameSplitterUpdate : Table.nameSplitterInsert) + getFieldName();
    ...
    public void renderHeader(RenderPrinter outputStream, Attribute headClass) throws Exception {
        ...
        String loadImageId = System.nanoTime() + "_ajax_loader_img";
        // else
