...
public class Form extends GenericWebControl implements ISubmitter
{
	...
	public void render(RenderPrinter outputStream) throws Exception
	{
		if (!isRendered() || !isAccessible())
			return;
		//		postBack.setPage(page);
		//		calendarScript.setPage(page);
		//		ajax.setPage(page);
		//		utilScript.setPage(page);
		...
		//		page.renderScripts(outputStream);
		//		if (page instanceof ContentPage)
		//			((ContentPage) page).getMasterPage().renderScripts(outputStream);
		//		else if (page instanceof MasterPage)
		//			((MasterPage) page).getContentPage().renderScripts(outputStream);
		setMethod("post");
