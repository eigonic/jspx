...
public abstract class PageModelComposer {
    ...
    private static final Object masterInsertLock = new Object();

    private static final Hashtable<String, Page> cachedPages = new Hashtable<String, Page>();

    private static final Hashtable<String, MasterPage> cachedMasters = new Hashtable<String, MasterPage>();
    ...
    public static Page getPage(String jspxFileName, ServletContext context, String locale, boolean isMasterPage, String charSet, boolean isPortlet)
        ...
        if (cachedPage == null) {
            ...
            try {
                ...
                throw new Exception("Could not find the jspx page [" + jspxFileName +
                        "]  please make sure that the file exists on the specidifed path");
            }
        }
    ...
    public static List<String> getCachedPages() {
        List<String> pages = new ArrayList<String>(cachedPages.keySet());
        return pages;
    }

    public static List<String> getCachedMasterPages() {
        List<String> pages = new ArrayList<String>(cachedMasters.keySet());
        return pages;
    }
