...
public class PropertyAccessor {
     ...
     *
     * @param object the object that is checked for the setter method.
     * @param name
     ...
     *
     * @param object the object that is checked for the getter method.
     * @param name
     ...
     *
     * @param object
     * @param method  that is to be invoked
     * @param value   the value to be set in the object
     * @param objects any extra information
