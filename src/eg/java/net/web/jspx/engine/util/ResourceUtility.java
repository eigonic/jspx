...
public class ResourceUtility {
    ...
    private static final HashMap<String, Resource> binaryResources = new HashMap<String, Resource>();
    ...
    protected static InputStream getLocalResourceStream(String resourceName) {
        return ResourceUtility.class.getResourceAsStream("/" + "resources/" + resourceName);
    }
