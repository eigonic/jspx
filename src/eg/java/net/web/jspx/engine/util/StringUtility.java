...
public class StringUtility
{
	...
	*/
		...
		while (stringTokenizer.hasMoreElements())
		{
			...
			if (token.equals("$"))
			{
				...
				if ("{".equals(nextToken))
				{
					...
					// set the EL
					complexEL.getValues().add(new StringBuilder("${").append(stringTokenizer.nextElement().toString().trim()).append("}").toString());
					// read the '}'
					try
					{
	...
	public static String evaluateComplexVlaue(String value, Page page, String dateformat)
	{
		...
		if (value != null && StringUtility.containsEL(value) && page != null && page.request != null && page.session != null)
		{
