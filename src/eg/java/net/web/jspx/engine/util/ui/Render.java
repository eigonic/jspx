...
public abstract class Render
{
	...
	// public static void renderIndent(RenderPrinter outputStream, int indentLevel) throws Exception
	// {
	...
	// public static void renderSelect(RenderPrinter outputStream, String name, String value, DataColumn column, String
	// javaScript, Page page)
	// throws Exception
	// {
	// createSelect(name, value, column, javaScript, page).render(outputStream);
	// }
	//
	// public static DropDown createSelect(String name, String value, DataColumn column, String javaScript, Page page)
	// {
	// DropDown dropDown = new DropDown();
	// dropDown.setName(name);
	// dropDown.setPage(page);
	// Object collection = ELUtility.evaluateEL("${this." + column.getListLookup() + "}", page);
	// // Object collection = PropertyAccessor.getProperty(page, column.getListLookup());
	// String selectedValue = "";
	// if (collection instanceof Collection<?>)
	// {
	// for (Object o : (Collection<?>) collection)
	// {
	// String val = String.valueOf(PropertyAccessor.getProperty(o, column.getLookupValue()));
	// String text = String.valueOf(PropertyAccessor.getProperty(o, column.getLookupText()));
	...
	public static void renderCloseTag(RenderPrinter outputStream, String tagName)
	{
		outputStream.write(Render.startEndTag);
		outputStream.write(tagName);
		outputStream.write(Render.endTag);
